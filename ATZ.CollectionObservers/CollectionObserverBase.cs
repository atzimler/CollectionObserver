...
{
    /// <summary>
    /// Abstract base class to provide change observer for ObservableCollections.
    /// </summary>
    ...
    public abstract class CollectionObserverBase<TSource, TTarget, TTargetCollection> : ICollectionChangedEventSource<TSource, TTarget>
    {
